...
3. evidence_is_valid = true ก็ต่อเมื่อ evidence นั้นปรากฏอยู่จริงในข้อความ resume ต้นฉบับ ไม่ว่าจะเป็นส่วนใดก็ตาม (work_experience, skills list, summary, highlights, education)
   - เกณฑ์เดียวที่ใช้ตัดสิน: "ข้อความ evidence นี้มีอยู่จริงใน resume ต้นฉบับหรือไม่"
   - ไม่ตัดสินจากความยาว ความละเอียด หรือบริบทของข้อความ — นั่นไม่ใช่หน้าที่ของ Judge
   - ตัวอย่างที่ต้อง accept: "QuickBooks" ถ้า QuickBooks ปรากฏอยู่จริงใน resume (เช่น ใน skills list)
   - ตัวอย่างที่ต้อง accept: "Adobe Creative Suite (Illustrator, Photoshop, InDesign)" ถ้าข้อความนี้มีอยู่จริงใน resume
   - **กฎ bilingual resume**: resume อาจเป็นภาษาไทย ภาษาอังกฤษ หรือมีทั้งสองภาษาในเล่มเดียว (bilingual)
     - ถ้า resume มีภาษาไทย evidence ที่เป็นภาษาไทยก็ถือว่า valid ถ้าข้อความนั้นปรากฏจริงในส่วนภาษาไทยของ resume
     - ถ้า resume มีภาษาอังกฤษ evidence ที่เป็นภาษาอังกฤษก็ถือว่า valid ถ้าข้อความนั้นปรากฏจริงในส่วนภาษาอังกฤษของ resume
     - ห้าม reject evidence เพียงเพราะภาษาไม่ตรงกับ JD — ให้ดูว่าข้อความนั้นมีใน resume หรือไม่ เท่านั้น
4. evidence_is_valid = false ถ้า:
   - หาข้อความ evidence นั้นในเรซูเม่ไม่เจอเลย (ไม่ว่าจะค้นในส่วนไหนหรือภาษาใดก็ตาม)
   - evidence เป็นการสรุป/ตีความ/สร้างขึ้นมาใหม่โดยไม่มีข้อความต้นฉบับรองรับ (hallucination)
...
6. ตรวจสอบอย่างเข้มงวดในประเด็นที่ถูกต้อง: "evidence มีอยู่จริงใน resume หรือไม่" เท่านั้น ห้ามตัดสินในประเด็นที่ไม่ใช่หน้าที่ (เช่น ข้อความสั้นเกินไป, ไม่มีคำกริยา, ภาษาไม่ตรงกับ JD ฯลฯ)
"""
